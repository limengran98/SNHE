...
from torch_geometric.nn import HeteroConv, Linear, SAGEConv, HypergraphConv,GCNConv,GATConv
...
class Attention(nn.Module):
    ...
    def forward(self, embeds):
        ...
        #beta = [torch.Tensor([0.38]),torch.Tensor([0.62])]
...
class Mp_encoder(nn.Module):
    def __init__(self, P, hidden_dim, attn_drop):
        ...
        self.P = P
        self.node_level = nn.ModuleList([HypergraphConv(hidden_dim, hidden_dim) for _ in range(P)])
